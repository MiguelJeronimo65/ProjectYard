...
public static class Icons
{
    private static readonly Dictionary<string, string[]> Paths = new()
    {
        ...
        ["pin"] = new[] { "M12 17v5", "M5 17h14v-1.76a2 2 0 0 0-1.11-1.79l-1.78-.9A2 2 0 0 1 15 10.76V6h1a2 2 0 0 0 0-4H8a2 2 0 0 0 0 4h1v4.76a2 2 0 0 1-1.11 1.79l-1.78.9A2 2 0 0 0 5 15.24z" },
        ["checks"] = new[] { "M18 6 7 17l-5-5", "m22 10-7.5 7.5L13 16" },
    };
